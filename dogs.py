...
class Dog(pygame.sprite.Sprite):
    ...
    def shooted(self, *args):
        ...
        pygame.mixer.music.load("data/dog.mp3")
...
class RebornedDog(pygame.sprite.Sprite):
    ...
    def update(self, *args):
        ...
        if self.rect.y + self.rect.width < 0:
            ...
            END = True
            its_end('bad_end')
            pygame.mixer.music.load("data/fail.mp3")
            pygame.mixer.music.play()
            self.kill()
...
class Duck(pygame.sprite.Sprite):
    ...
    def shooted(self, *args):
        ...
        pygame.mixer.music.load("data/hits.mp3")
        pygame.mixer.music.play()
...
def first_screen():
    ...
    INTRO_TEXT = ['DUCK HUNT', '',
                  '0. Уровень определяет скорость',
                  'движения уток.',
                  '1. Вам нужно сбить 20 уток.',
                  '2. Чтобы выстрелить из ружья ',
                  'нажимайте левую кнопку мыши.',
                  '3. Для продолжения выберите',
                  'уровень.']
    ...
    pygame.display.flip()
    pygame.mixer.music.load("data/registration.mp3")
    pygame.mixer.music.play()
    while True:
...
if __name__ == "__main__":
    while True:
        ...
        IMAGES = {"frontground": pygame.transform.scale(load_image('frontground.png'), (WIDTH, HEIGHT)),
                  ...
                  "first_screen": pygame.transform.scale(load_image('fon.jpg'), (WIDTH, HEIGHT)),
